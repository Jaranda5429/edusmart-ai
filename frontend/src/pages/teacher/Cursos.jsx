          ...
          <div style={{ background: "#1C1535", borderRadius: 20, border: "1px solid rgba(124,58,237,0.3)", boxShadow: "0 20px 60px rgba(0,0,0,0.7)", width: "100%", maxWidth: 672, display: "flex", flexDirection: "column", maxHeight: "90vh" }}>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: 28, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div className="bg-purple-50 rounded-xl p-5 space-y-3 border border-purple-100">
                ...
                <input value={pregTemp.texto} onChange={e => setPregTemp(p => ({ ...p, texto: e.target.value }))} placeholder="Escribe la pregunta..." className={inp} style={{ background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(124,58,237,0.3)', color: '#E5E7EB' }} />
                <p className="text-xs text-[rgba(156,163,175,0.7)] font-semibold">Opciones (marca la correcta)</p>
                {pregTemp.opciones.map((o, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <input value={o} onChange={e => setPregTemp(p => { const ops = [...p.opciones]; ops[i] = e.target.value; return { ...p, opciones: ops } })} placeholder={'Opcion ' + (i + 1)} className={inp} style={{ background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(124,58,237,0.3)', color: '#E5E7EB' }} />
                  </div>
                ))}
